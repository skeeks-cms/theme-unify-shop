...
<header id="js-header" class="<?= $this->theme->is_header_sticky ? "u-header--sticky-top" : ""; ?> <?= $this->theme->header_shadow; ?> sx-no-print u-header u-header--show-hide u-header--change-appearance" data-header-fix-moment="300" data-header-fix-effect="slide">
                ...
                <? else : ?>
                    ...
                    <a class="d-block u-link-v5 g-color-white-opacity-0_8 g-font-weight-600 " href="<?= \yii\helpers\Url::to(['/cms/upa-personal/update']) ?>">
                        ...
                        <span class="g-pos-rel g-top-2">
                            <span class="g-hidden-sm-down">Кабинет</span>
                        </span>
                    </a>
                <? endif; ?>
            </div>
