 ...
 * @author Semenov Alexander <semenov@skeeks.com>
 */
class ProductListImagesV2Asset extends AssetBundle
{
    public $sourcePath = '@skeeks/cms/themes/unifyshop/assets/src/components/product-list-images-v2';

    public $css = [
    ];
    public $js = [
        'product-list-images-v2.js',
    ];
    public $depends = [
        JqueryAsset::class,
    ];
